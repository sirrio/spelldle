...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer">Free tool <span aria-hidden="true">·</span> powered by <a href="https://sirrio.de/" target="_blank" rel="noreferrer">sirrio.de</a></footer>
    </main>
  );
}
